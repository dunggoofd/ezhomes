    ...
    <section className="relative min-h-[100vh] flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-full mb-8 animate-fade-up">
            <span className="text-sm font-medium tracking-wide">TRUSTED IN 300,000+ HOMES</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1] animate-fade-up [animation-delay:0.1s]">
            Furniture That
          ...
          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-white/80 mb-10 leading-relaxed max-w-2xl animate-fade-up [animation-delay:0.2s]">
            Modular, space-saving furniture designed to adapt to how you live. 
            Ships in a compact box. Assembles in minutes.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-up [animation-delay:0.3s]">
            <div className="flex flex-col gap-2">
              <Button 
                asChild
                size="lg" 
                className="bg-white text-primary hover:bg-white/90 text-base font-semibold px-8 py-6 rounded-none"
              >
