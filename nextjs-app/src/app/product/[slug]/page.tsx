	...
	return (
		<Layout>
			...
			<div className="container mx-auto px-6 sm:px-8 lg:px-12 py-3 md:py-4">
				<Link href="/shop" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors min-h-[44px] -ml-2 px-2 active:scale-95">
